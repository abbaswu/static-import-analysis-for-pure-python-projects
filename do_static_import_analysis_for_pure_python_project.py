...
from get_module_name_to_file_path_dict_for_pure_python_project import get_module_name_to_file_path_dict_for_pure_python_project

# Returns four values
# module_name_to_file_path_dict: dict[str, str]
# module_name_to_defined_function_name_set_dict: dict[str, set[str]]
# module_name_to_defined_class_name_set_dict: dict[str, set[str]]
# imported_external_module_name_set: set[str]
def do_static_import_analysis_for_pure_python_project(project_path: str) -> tuple[dict[str, str], dict[str, set[str]], dict[str, set[str]], set[str]]:
    module_name_to_file_path_dict: dict[str, str] = get_module_name_to_file_path_dict_for_pure_python_project(project_path)

    module_name_to_defined_function_name_set_dict: dict[str, set[str]] = dict()
    module_name_to_defined_class_name_set_dict: dict[str, set[str]] = dict()
    imported_external_module_name_set: set[str] = set()

    for module_name, file_path in module_name_to_file_path_dict.items():
        # update module_name_to_defined_function_name_set_dict, module_name_to_defined_class_name_set_dict
        ...
        module_name_to_defined_class_name_set_dict[module_name] = class_names

        # update imported_external_modules
    ...
    return module_name_to_file_path_dict, module_name_to_defined_function_name_set_dict, module_name_to_defined_class_name_set_dict, imported_external_module_name_set
